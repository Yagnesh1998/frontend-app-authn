...
import {
  DEFAULT_STATE, INVALID_NAME_REGEX,
  LETTER_REGEX, NUMBER_REGEX, REDIRECT, VALID_EMAIL_REGEX,
} from '../data/constants';
import {
  getAllPossibleQueryParams, isHostAvailableInQueryParams, setCookie,
} from '../data/utils';

const emailRegex = new RegExp(VALID_EMAIL_REGEX, 'i');
const urlRegex = new RegExp(INVALID_NAME_REGEX);

const EmbedableRegistrationForm = (props) => {
  const {
    backedUpFormData,
    backendCountryCode,
    backendValidations,
  ...
  const [autoSubmitRegisterForm] = useState(false);
...
EmbedableRegistrationForm.propTypes = {
...
EmbedableRegistrationForm.defaultProps = {
  backedUpFormData: {
